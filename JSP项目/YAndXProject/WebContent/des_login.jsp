...
<html lang="zh-CN">
  ...
  <body>
	...
	<ul id="myTab" class="nav nav-tabs col-xs-12 col-sm-10 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
		...
		<li><a href="<%=path %>/login/com" >装修公司登入</a></li>
		<li><a href="<%=path %>/login/sup">建材商登入</a></li>
		<li class="active"><a href="<%=path %>/login/des">设计师登入</a></li>
	</ul>
	...
	<form action="<%=path %>/login/dess" method="post">
		<span id=loginCuo>${requestScope.loginCuo }</span>
		<table>
