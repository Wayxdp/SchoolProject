...
<html lang="zh-CN">
  ...
  <body>
	...
	<ul id="myTab" class="nav nav-tabs col-xs-12 col-sm-10 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2">
		...
		<li class="active"><a href="<%=path %>/reg/com" >装修公司申请入驻</a></li>
		<li><a href="<%=path %>/reg/sup">建材商申请入驻</a></li>
		<li ><a href="<%=path %>/reg/des">设计师申请入驻</a></li>
	</ul>
	...
	<br/><br/>
	<form action="<%=path %>/reg/coms" method="post">
		<table>
			...
			<tr class="form-group input-group">
				<td>负责人：</td>
				<td><input name="principal" id="principal" type="text" placeholder="请输入负责人姓名" /></td>
