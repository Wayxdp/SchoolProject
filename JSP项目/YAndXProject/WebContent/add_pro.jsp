    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>添加商品</small></div>
            </div>

            <div class="am-g">
                <div class="am-u-sm-12 am-u-lg-8 am-u-lg-offset-2">
                            ...
                            <form id="form" class="am-form am-form-horizontal">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-12">
                                        <input type="button" class="am-btn am-btn-primary am-btn-block" value="提交商品" onclick="cus_reg();"/>
                                    </div>
                                </div>
                            </form>
                        </div>
