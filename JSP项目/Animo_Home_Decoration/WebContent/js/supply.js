...
function reg() {
	$.post("/Animo_Home_Decoration/supply/regverify", $("#form").serialize(),
			function(data) {
				if (data.info == 'email') {
					var emailspan = document.getElementById("emailspan");
				...
				if (data.info == 'succeed') {
					window.location = "/Animo_Home_Decoration/index/supplylogin";
				}
			}, "JSON");
}
...
function login(){
	$.post("/Animo_Home_Decoration/supply/loginverify", $("#form").serialize(),
			function(data) {
				if (data.info == 'noemail') {
					var emailspan = document.getElementById("emailspan");
