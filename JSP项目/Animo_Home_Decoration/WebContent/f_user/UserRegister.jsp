				...
				<div class="grid-370 fn-clear">
					<ul class="tab-choose">
						<li class="tab-choose-item"><a
							href="<%=path%>/index/customerlogin">登录</a></li>
						<li class="tab-choose-item selected"><a
							href="<%=path%>/index/customerreg">注册</a></li>
					</ul>
				</div>
				...
				<div class="grid-370">
					<form class="ui-form ui-form-l ui-form-general" id="form"
						...
						<fieldset>
							...
							<div class="ui-form-item">
							<span id="pwdspan" style="color: red;">${requestScope.pwdspan}</span>
							...
							<div class="ui-form-item">
							<span id="namespan" style="color: red;">${requestScope.namespan }</span>
