...
<div class="grid-370 fn-clear">
    <ul class="tab-choose">
        <li class="tab-choose-item selected">
            <a href="<%=path%>/index/designerlogin">登录</a>
        </li>
        <li class="tab-choose-item">
            <a href="<%=path%>/index/designerreg">注册</a>
        </li>
    </ul>
</div>
				<div class="grid-370">
...
<script src="<%=path%>/js/seajs-config.js"></script>
<script src="<%=path%>/js/v.js"></script>
<script src="<%=path%>/js/hm.js"></script>
