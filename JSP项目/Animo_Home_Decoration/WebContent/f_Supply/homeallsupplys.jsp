...
<body>
	...
	<div class="bg-white elite-list elite-detaile-content mt20">
						...
						<div class="col-xs-3">
							<div class="item text-center">
								...
								<div class="box1">
									...
									<p>
										<a href="<%=path %>/supply/supplycollect?id=${supplys.id}"
											onclick="doyoo.util.openChat(&#39;g=10059956&#39;);return false;"
											class="zixun">收藏</a>
											<a href="<%=path %>/supply/userconsult?id=${supplys.id}" class="guihua" target="_blank">免费咨询</a>
									</p>
			...
			<div class="paging">
			<a href="<%=path %>/customer/homeallsupply?pageNo=1">首页</a>
			<a href="<%=path %>/customer/homeallsupply?pageNo=${currPage - 1}">上一页</a> 
			<a href="<%=path %>/customer/homeallsupply?pageNo=${currPage - 1}">下一页</a> 
			<a href="<%=path %>/customer/homeallsupply?pageNo=${requestScope.totalPage}">末页</a>
		</div>		
