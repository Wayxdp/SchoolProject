		...
		<div class="content">
			<div class="user-info bg-white clearfix">
				<div class="page-title">
					<span class="tit">建材商资料</span>
				</div>
				<form enctype="multipart/form-data" method="post" id="fileform"
					action="<%=path %>/supply/updatedatasucceed" class="form-horizontal">
					<input type="hidden" value="user" name="action">
					<div class="edit-head clearfix">
						<span class="pic"><img id="ImgPr"
							src="<%=path %>/${sessionScope.supply1.logo }" width="80" height="80"
							class="coverPic"></span>
						<div class="modify">
							修改头像<input type="file" name="logo"
								accept="image/*" id="up">
						</div>
					</div>
					<div class="info-list mt20">
							...
							<ul>
								<li><label>邮箱</label> <input style="border: none;" readonly="readonly" type="text" class="txt"
									id="email" name="email"  value=${sessionScope.supply1.email }> <span
									class="error text-red"></span></li>
								<li><label>公司名称</label> <input type="text" class="txt"
									id="name" name="name"  value=${sessionScope.supply1.name }> <span
									class="error text-red"></span></li>
								<li><label>负责人</label> <input type="text" class="txt"
									id="principal" name="principal"  value=${sessionScope.supply1.principal }>
									<span class="error text-red"></span></li>

								<li><label>地址</label> <input type="text" id="address"
									name="address" class="txt"  value=${sessionScope.supply1.address }> <span
									class="error text-red"></span></li>
								<li><label>手机号</label> <input type="text" id="phone"
									name="phone" class="txt"  value=${sessionScope.supply1.phone }> <span
									class="error text-red"></span></li>
								<li><label>固定电话</label> <input type="text" id="tel"
									name="tel" class="txt"  value=${sessionScope.supply1.tel }> <span
									class="error text-red"></span></li>
								<li><label>成立日期</label> <input type="text" style="border: none;" readonly="readonly" id="open_date"
									name="open_date" class="txt"  value=${sessionScope.supply1.open_date }> <span
									class="error text-red"></span></li>
								<li><label>经度</label> <input type="text" id="longitude"
									name="longitude" class="txt"  value=${sessionScope.supply1.longitude }> <span
									class="error text-red"></span></li>
										<li><label>纬度</label> <input type="text" id="latitude"
									name="latitude" class="txt"  value=${sessionScope.supply1.latitude }> <span
									class="error text-red"></span></li>
								<li><label>描述</label> <input type="text" id="des"
									name="des" class="txt"  value=${sessionScope.supply1.des }> <span
									class="error text-red"></span></li>
								<li><label>最近登录时间</label> <input style="border: none;" readonly="readonly"
									...
									value=${sessionScope.supply1.last_login_time }> <span class="error text-red"></span></li>
							</ul>
