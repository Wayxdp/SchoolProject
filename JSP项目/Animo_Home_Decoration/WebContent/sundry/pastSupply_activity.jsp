			...
			<div class="activity clearfix mt20">
				<div class="le_nav fl">
					<div class="link_list">
						...
						<a href="<%=path %>/supply/pastsupplyActivity" class="name1 db  current">建材商往期活动<span class="fr">&gt;</span></a>
						<a href="<%=path%>/company/companyActivity" class="name2 db ">装修公司活动<span
							class="fr">&gt;</span></a> <a href="<%=path%>/supply/supplyActivity"
							class="name2 db">建材商活动<span class="fr">&gt;</span></a>
						</div>
				...
				<div class="right_cont fr">
					...
					<div class="paging">
						<a href="<%=path %>/supply/pastsupplyActivity?pageNo=1">首页</a>
						<a href="<%=path %>/supply/pastsupplyActivity?pageNo=${currPage - 1}">上一页</a> 
						<a href="<%=path %>/supply/pastsupplyActivity?pageNo=${currPage + 1}">下一页</a> 
						<a href="<%=path %>/supply/pastsupplyActivity?pageNo=${requestScope.totalPage }">末页</a>
					</div>
				</div>
			</div>
		</div>
