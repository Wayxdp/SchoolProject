			...
			<div class="activity clearfix mt20">
				...
				<div class="le_nav fl">
					<div class="link_list">
						...
						<a href="<%=path%>/company/companyActivity" class="name2 db  current">装修公司活动<span
				...
				<div class="right_cont fr">
					...
					<div class="bg-white guide-detaile-content">
		            	<div class="article">
		                    <h1 class="text-center">${requestScope.company_activity.name }</h1>
		                    <div class="row text-center info-bar">
		                    	<div class="col-xs-6 text-right">
		                        	<span>发布时间：${requestScope.company_activity.created_time}</span>
		                    ...
		                    <div class="con">
		                        <p style="margin: 0pt;">
		                        	${requestScope.company_activity.des }
		                        	<img src="<%=path %>/${requestScope.company_activity.image}" />
		                        </p>
		                    </div>
