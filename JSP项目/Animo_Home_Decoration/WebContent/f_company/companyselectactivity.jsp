...
<div class="container">
	<div class="col-lg-6 col-lg-offset-3" style="padding-top: 60px;">
		<p>活动名称:${requestScope.companyactivity.name }</p>
		<p>活动描述:${requestScope.companyactivity.des }</p>
		<c:if test="${requestScope.companyactivity.status=='Y'}"><p>活动状态:可用</p></c:if>
		<c:if test="${requestScope.companyactivity.status=='N'}"><p>活动状态:已冻结</p></c:if>
	</div>
</div>
