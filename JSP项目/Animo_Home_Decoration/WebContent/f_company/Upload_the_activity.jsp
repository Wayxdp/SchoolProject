...
<body>
	<form enctype="multipart/form-data" action="<%=path %>/company/add_activities" method="post" class="col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4" style="padding-top: 60px;">
