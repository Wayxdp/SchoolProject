		...
		<div class="w1200">
			<div class="container">
				<ul class="caseDetail-push-list1 clearfix">
					<c:forEach items="${requestScope.CompanycaseAndCompanys }" var="CompanycaseAndCompanys">
					<li>
						<div class="pic">
							<a href="<%=path %>/designer/homecasedetails?caseid=${CompanycaseAndCompanys.id}" target="_blank"><img
								class="lazy" style="width: 100%;height: 100%;"
								src="<%=path %>/${CompanycaseAndCompanys.image_1}"
								style="display: block;"></a> 
								<a href="<%=path %>/company/enshrine?caseid=${CompanycaseAndCompanys.id}"
						...
						<div class="caseDetail-push-imgfont relative">
							<a href="http://www.dyrs.com.cn/designer/1543" target="_blank"
								...
								src="<%=path %>/${CompanycaseAndCompanys.logo}"
								alt=""></a>
							<p class="caseDetail-push-imgfont-name">
								<a href="http://www.dyrs.com.cn/case/107579"></a>
							</p>
							<p class="caseDetail-push-imgfont-setting">
								<span>小区名称：</span>${CompanycaseAndCompanys.plot_name}
								<br/><span>案例名称：</span>${CompanycaseAndCompanys.name}
							</p>
							<!--box-->
								...
								<div class="box relative">
									...
									<div class="caseDetail-box-intro">
										<ul class="clearfix">
											...
											<li class="caseDetail-box-img-intro">
												<p>
													<span class="caseDetail-box-label">装修公司：</span><span
														style="color: #f83536;">${CompanycaseAndCompanys.company_name}</span>
												</p>
												<p>
													<span class="caseDetail-box-label">成立时间：</span><span>${CompanycaseAndCompanys.open_date}</span>
												</p>
												<p>
												...
												<p
													...
													<span class="caseDetail-box-label">负责人：</span> ${CompanycaseAndCompanys.principal}
												</p>
											</li>
										</ul>
									</div>
									<div class="textcenter">
										<a class="box-btn box-btn-active"
											href="<%=path%>/company/decoration_company?id=${CompanycaseAndCompanys.company_id}"
											target="_blank">看Ta的案例</a> <a href="<%=path %>/designer/userconsult?id=${CompanycaseAndCompanys.id}" 
